...
public class DecartsLeaf implements Shape, Serializable, Cloneable, Transferable
{
    ...
    public Object clone()
    {
        try
        {
            DecartsLeaf s = (DecartsLeaf) super.clone(); // make a copy of all
                                                         // fields
            return s;
    ...
    public static DataFlavor decDataFlavor = new DataFlavor(DecartsLeaf.class, "DecartsLeaf");
    ...
    public static DecartsLeaf getFromString(String s)
    {
        String[] arr = s.split(" ");
        return new DecartsLeaf(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]), Integer.parseInt(arr[2]), Integer
                .parseInt(arr[3]), Double.parseDouble(arr[4]));
    }
